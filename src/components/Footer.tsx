  ...
  return (
    <footer className="bg-[#050505] text-white pt-20 pb-8 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        {/* Main Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-16 relative z-10">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="space-y-3.5">
              <div className="flex items-center gap-3">
                <span className="w-5 h-5 flex items-center justify-center rounded-full bg-[#d4af37]/10 text-[#d4af37]">
            ...
            <div className="flex items-center gap-2.5 pt-2">
              <a href="#" aria-label="LinkedIn" className="group w-9 h-9 flex items-center justify-center rounded-lg bg-[#0d0d0d] border border-white/10 hover:border-white/20 hover:bg-[#141414] transition-all">
              ...
              <a href="#" aria-label="X" className="group w-9 h-9 flex items-center justify-center rounded-lg bg-[#0d0d0d] border border-white/10 hover:border-white/20 hover:bg-[#141414] transition-all">
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#" aria-label="GitHub" className="group w-9 h-9 flex items-center justify-center rounded-lg bg-[#0d0d0d] border border-white/10 hover:border-white/20 hover:bg-[#141414] transition-all">
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="YouTube" className="group w-9 h-9 flex items-center justify-center rounded-lg bg-[#0d0d0d] border border-white/10 hover:border-white/20 hover:bg-[#141414] transition-all">
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-6 grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            {/* PRODUCTS */}
            <div>
              <h4 className="text-xs font-semibold text-[#d4af37] uppercase tracking-widest mb-6">
                Products
              </h4>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <form onSubmit={handleSubscribe} className="space-y-3">
              <input
                ...
                required
                className="w-full bg-transparent border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#d4af37] transition duration-300"
              />
              <button
                type="submit"
                className="w-full bg-[#d4af37] hover:bg-[#e5c158] text-black font-semibold text-xs rounded-xl py-3.5 px-6 flex items-center justify-between transition duration-300"
              >
        ...
        <div className="relative w-full h-[260px] mb-12 border-t border-white/5 pt-8 overflow-hidden select-none">
          ...
          <div className="absolute inset-0 max-w-5xl mx-auto w-full h-full">
            ...
            {/* London */}
            <div className="absolute left-[49%] top-[25%] flex items-center gap-2">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#d4af37] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#d4af37]"></span>
              </span>
              <span className="text-[10px] font-semibold text-gray-400 tracking-wider">London</span>
            </div>

            {/* Lagos */}
            <div className="absolute left-[41.5%] top-[56%] flex items-center gap-2 translate-x-[-100%]">
              <span className="text-[10px] font-semibold text-gray-400 tracking-wider">Lagos</span>
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#d4af37] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#d4af37]"></span>
              </span>
            ...
            {/* Abuja */}
            <div className="absolute left-[45.5%] top-[60%] flex items-center gap-2">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#d4af37] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#d4af37]"></span>
              </span>
              <span className="text-[10px] font-semibold text-gray-400 tracking-wider">Abuja</span>
            </div>

            {/* Dubai */}
            <div className="absolute left-[56.5%] top-[45%] flex items-center gap-2">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#d4af37] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#d4af37]"></span>
              </span>
              <span className="text-[10px] font-semibold text-gray-400 tracking-wider">Dubai</span>
            </div>

            {/* Singapore */}
            <div className="absolute left-[70%] top-[70%] flex items-center gap-2">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#d4af37] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#d4af37]"></span>
              </span>
              <span className="text-[10px] font-semibold text-gray-400 tracking-wider">Singapore</span>
            </div>
        ...
        {/* Bottom Bar Divider */}
        <div className="w-full h-[1px] bg-[#d4af37]/20 mb-8"></div>

        {/* Bottom Bar Info */}
        <div className="flex flex-wrap items-center justify-between gap-y-4 text-[10px] text-gray-500 font-medium">
