  ...
  return (
    <section className="h-screen relative overflow-hidden flex flex-col">
      ...
      <div className="relative flex-1 flex flex-col justify-between">
        ...
        {/* Bottom Section: Tab Navigation Control Panel */}
        <div className="relative">
          {/* Subtle Divider Line */}
          <div className="max-w-7xl mx-auto px-6">
            <div className="border-t border-[#1f2937]/50" />
          </div>

          {/* Tab Navigation with Semi-transparent Background */}
          <div className="bg-black/40 backdrop-blur-md py-6">
            <div className="max-w-7xl mx-auto px-6">
